...
export const Perplexity: Icon = ({ className, ...props }) => (
  <svg {...props} preserveAspectRatio="xMidYMid" viewBox="0 0 2700 2700" className={className}>
    <path
      fill="#000"
      d="M185 2691c-86-21-158-93-175-175-7-35-10-415-8-1196 3-1276-2-1180 73-1253 20-20 54-42 74-49 53-19 2349-19 2402 0 20 7 54 29 74 49 75 73 70-23 73 1253 2 817-1 1161-9 1200-9 46-19 63-64 106-42 41-63 54-104 63-59 13-2284 14-2336 2z"
    />
    <path
      fill="#fff"
      d="m971 2144 314-255 3 255 2 256h120l2-255 3-256 315 257 315 257 3-292 2-291h270v-900h-270l-2-296-3-295-312 275c-172 152-315 276-318 276-3 0-5-133-5-295v-295h-120v295c0 162-2 295-5 295-3 0-146-124-318-276l-312-276-3 296-2 296H380v900h270v290c0 160 2 290 4 290 2 0 145-115 317-256z"
    />
    <path
      fill="#000"
      d="M780 1981v-161h431l-203 151c-112 84-209 156-215 162-10 7-13-24-13-152zm926 1-210-157 209-3c114-1 210-1 212 1 2 2 2 74 1 160l-3 156-209-157zM510 1370v-330h140v176l38 35c20 20 146 127 280 239 133 111 242 204 242 206 0 2-157 4-350 4H510v-330zm980 326c0-2 126-102 280-223l280-218v-215h140v660h-350c-192 0-350-2-350-4zm-462-304-247-217v-558c8 4 122 104 255 222l254 214v557c-5 0-119-98-255-218zm382-60v-279l242-214c133-118 247-218 255-222 11-7 13 42 12 275v283l-245 215c-135 118-249 217-254 218-6 2-10-101-10-276z"
    />
  </svg>
);
