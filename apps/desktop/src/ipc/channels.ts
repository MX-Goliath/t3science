...
export const GET_DESKTOP_PETS_STATE_CHANNEL = "desktop:get-desktop-pets-state";
export const SET_DESKTOP_PETS_ENABLED_CHANNEL = "desktop:set-desktop-pets-enabled";
export const ASSIGN_DESKTOP_PET_CHANNEL = "desktop:assign-desktop-pet";
export const IMPORT_DESKTOP_PET_ARCHIVE_CHANNEL = "desktop:import-desktop-pet-archive";
export const REMOVE_DESKTOP_PET_CHANNEL = "desktop:remove-desktop-pet";
export const GET_SYSTEM_INTEGRATION_STATE_CHANNEL = "desktop:get-system-integration-state";
export const SET_SYSTEM_INTEGRATION_SETTINGS_CHANNEL = "desktop:set-system-integration-settings";
