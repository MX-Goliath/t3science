...
function getGnomeKeyringRemediationMessage(): string {
  return "T3 Science could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart T3 Science.";
}

function getKWalletRemediationMessage(): string {
  return "T3 Science could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart T3 Science.";
}
