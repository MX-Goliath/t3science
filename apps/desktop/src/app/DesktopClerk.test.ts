...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "t3science-dev" : "t3science",
    legacyUserDataDirName: isDevelopment ? "T3 Science (Dev)" : "T3 Science (Alpha)",
...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "t3science-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, [
        "setPath:userData:/tmp/app-data/t3science-dev",
        "createClerkBridge",
      ]);
  ...
  it.each([
    { isDevelopment: true, scheme: "t3science-dev" },
    { isDevelopment: false, scheme: "t3science" },
