...
import { DESKTOP_LINUX_URL_HANDLER_DESKTOP_ENTRY_NAME } from "@t3tools/shared/desktopProductIdentity";
...
export const URL_HANDLER_DESKTOP_ENTRY_NAME = DESKTOP_LINUX_URL_HANDLER_DESKTOP_ENTRY_NAME;
